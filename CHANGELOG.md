...
- Enhance task execution with progress support and status updates
- Improve open_system_folder function for better OS compatibility
- Add OS compatibility checks and store OS information in snapshots
## [0.6.6] - 2026-08-27
...
- Enhance coverage for SnapshotCatalogue and SnapshotManager with additional exception handling tests
## [0.6.4] - 2026-05-31
...
- Clean up unused imports, type hints, and code throughout the codebase
- Standardize project structure by adding missing package init files and applying consistent code formatting across the codebase
- Reorder and organize import statements for improved readability and consistency across multiple files
- Remove trailing newlines and streamline code formatting across multiple files
- Add platform markers for onnxruntime-gpu dependencies in configuration files
- Update Makefile for improved CI quality checks and add configuration for Ty

### ⚙️ Miscellaneous Tasks

- Update changelog [skip ci]
- Add ruff configuration file for linting and formatting settings
- Add dedicated ty configuration file
## [0.6.1] - 2026-04-08
...
- Implement AiMediaScanner for AI media scanning with support for tags, NSFW detection, and OCR
- Add AiPayloadMediaInfo model and update imports in media scanner
- Add video frame sampling and media source resolution utilities
- Update dependencies for AI models and add platform-specific requirements
- Add integration tests for AiMediaScanner and media source resolution utilities
...
- Add get_video_creation_date method to VideoUtils
- Set creation date in generated XMP files
- Add creation date extraction and setting to MetadataHandler
- Enhance media creation date extraction logic
## [0.5.12] - 2026-02-16
...
- Use rich console for conflict warnings in media organizer
...
- Move XMP generation after user confirmation in organizer cli
- Prevent filename collisions during temporary XMP generation

### 🧪 Testing

- Add unit test for XMP generation collision handling
## [0.5.11] - 2026-02-14
...
- Add print_hw method to PylizApp class
## [0.5.9] - 2026-02-13
...
- Rename pyliz-media application configuration in project.mk
...
- Make path and output arguments optional in organizer cli
## [0.5.6] - 2026-02-12

### Build

- Rename pyliz-media application to pylizmedia
