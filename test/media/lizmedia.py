...
class TestLizMedia(unittest.TestCase):
    ...
    def test_exif_data(self, _, __):
        ...
        with patch("builtins.open", mock_open(read_data=b"data")), patch("pylizlib.media.lizmedia.exifread.process_file") as mock_exif:
    ...
    def test_creation_date_xmp_priority(self, _, __):
        ...
        with patch("pathlib.Path.exists", return_value=True), patch("builtins.open", mock_open(read_data=xmp_content)), patch("pylizlib.media.lizmedia.exifread.process_file", return_value={}):
